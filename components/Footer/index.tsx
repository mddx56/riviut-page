...
import WALottie from "../Lotties/WhatsappLottie";
        ...
        <div className="mx-auto max-w-c-1390 px-4 md:px-8 2xl:px-0">
              ...
              <div className="flex w-full flex-col gap-8 md:flex-row md:justify-between md:gap-0 lg:w-2/3 xl:w-7/12">
                ...
                >
                  ...
                  <ul className="flex items-center gap-5">
                    <li>
                      <a
                        href="https://www.facebook.com/riviutclinica"
                        ...
                        >
                          <g fill="none">
                            <rect
                              width="256"
                              height="256"
                              fill="url(#IconifyId19364fe729eb95b9f2)"
                              rx="60"
                            />
                            <rect
                              width="256"
                              height="256"
                              fill="url(#IconifyId19364fe729eb95b9f3)"
                              rx="60"
                            />
                            <path
                              fill="#fff"
                            ...
                            <defs>
                              <radialGradient
                                id="IconifyId19364fe729eb95b9f2"
                                cx="0"
                                cy="0"
                                r="1"
                              ...
                              <radialGradient
                                id="IconifyId19364fe729eb95b9f3"
                                cx="0"
                                cy="0"
                                r="1"
          ...
          <div className="flex flex-col flex-wrap items-center justify-center gap-5 border-t border-stroke py-7 dark:border-strokedark lg:flex-row lg:justify-between lg:gap-0">
            ...
            <motion.div
              ...
              className="animate_top"
            >
              <p>&copy; {new Date().getFullYear()} JWP Labs</p>
            </motion.div>
